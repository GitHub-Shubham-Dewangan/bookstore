    ...
    <>
      ...
      {OrderHistory && OrderHistory.length === 0 && (
        <div className="h-[88vh] p-4 text-zinc-100">
          <div className="h-[100%] flex flex-col items-center justify-center">
            ...
            <img
              src="https://www.pngkey.com/png/full/29-298571_history-icon-png-image-history-icon-transparent-background.png"
              alt="History Icon"
      ...
      {OrderHistory && OrderHistory.length > 0 && (
        <div className="h-[100%] p-0 md:p-4 text-zinc-100">
          <h1 className="text-3xl md:text-5xl">Your Order History</h1>
