  ...
  return (
    <div className="flex bg-zinc-800 text-white px-8 py-4 items-center justify-between">
      ...
      <div className="nav-links-bookheaven flex items-center gap-4">
        ...
        <div className="flex gap-4">
          <button className="px-4 py-1 border border-blue-500 rounded hover:bg-white hover:text-zinc-800 transtition-all duration-300">
            LogIn
          </button>
          <button className="px-4 py-1 bg-blue-500 rounded hover:bg-white hover:text-zinc-800 transtition-all duration-300">
            SignUp
          </button>
        </div>
      </div>
